...
public class DepartmentDao {
    ...
    public static final String FIND_ALL_BY_ID = "SELECT * FROM DEPARTMENT WHERE ID = ?";
    ...
    public Department findOneLazyById(Long id) {
    	Department department = jdbcTemplate.queryForObject(FIND_ALL_BY_ID, new Object[]{id}, Department.ROW_MAPPER_NO_EMP);
